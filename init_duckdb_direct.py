#!/usr/bin/env python3
"""
Script directo para inicializar la base de datos DuckDB sin utilizar archivos SQL
"""
import os
import duckdb
...
def main():
    ...
    try:
        ...
        print("Creando tabla duckdb_servers...")
        conn.execute("""
        ...
        print("Insertando datos en duckdb_servers...")
        conn.execute("""
        ...
        print("Creando tabla duckdb_databases...")
        conn.execute("""
        ...
        print("Insertando datos en duckdb_databases...")
        conn.execute("""
        ...
        print("Creando tabla server_metrics...")
        conn.execute("""
        ...
        print("Insertando datos en server_metrics...")
        conn.execute("""
