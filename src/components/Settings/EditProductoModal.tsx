...
interface EditProductoModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (id: number, data: { nombre: string }) => Promise<void>;
  producto: any; // El producto a editar
}

export const EditProductoModal: React.FC<EditProductoModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  producto,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await onSubmit(producto.id, { nombre });
      onClose();
    } catch (error: any) {
