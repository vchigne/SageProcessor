"""
Parche para el procesador de archivos de SAGE con soporte para BOM en archivos CSV
y manejo robusto de columnas adicionales o faltantes.

Este módulo aplica parches al procesador de archivos para mejorar el manejo de:
- Archivos CSV con BOM (Byte Order Mark)
- Archivos CSV con más columnas que las definidas en el YAML
- Archivos CSV con menos columnas que las definidas en el YAML
"""
import os
import pandas as pd
from .file_processor import FileProcessor, create_column_names, detect_bom

def patched_read_file(self, file_path, catalog):
    """Versión parcheada del método _read_file con soporte para BOM y manejo de columnas adicionales"""
...
def remove_patched_read_file(original_read_file):
